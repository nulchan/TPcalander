	...
	function mini_calendar(change_year,change_month){ 
		...
		var day = new Date(); 
  		...
  		function week_calandar(week) { 
      		...
      		var title2 = "<form action=../calander/search.jsp method=post><div id=content_search><input class=search_text type=text placeholder=일정검색><input class=search_button type=button value=검색></form></div>"
