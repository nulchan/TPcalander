...
<body>
	<div id="wrap">
		<div id="top">
			안녕하세요. <b><%=session.getAttribute("id") %></b>님 || <a
				href="../login/logout.jsp">로그아웃하기</a>
		</div>
		<div id="header">Calander - 8조</div>
		<div id="menu">
			<div id="menu_body">
				<input class="menu_button" type="button" value="일정쓰기"> <input
					class="menu_button" type="button" value="기념일관리">
				...
				<table id="menu_calander">
					...
					<tr class="mc_border">
						<td class="mc_border" colspan="7"></td>
					</tr>
					<tr id="week_col">
						<td id="sun">일</td>
						<td id="mon">월</td>
				...
				<div id="menu_memo">
					<form action="../calander/memostore.jsp" method="post">
						<div class="memo_box">
							<textarea cols="36" rows="10" name="memo" id="memo"
								placeholder="이 곳에 메모를 입력 할 수 있습니다"></textarea>
						</div>
						<input class="memo_button" type="submit" value="등록">
					</form>
				</div>
				<div id="menu_check">
					<a href="">전체 일정 보기</a></br> <a href="">중요 일정 보기</a></br> <a href="">오래된
						일정 삭제</a></br> <a href="../calander/show_memo.jsp">메모 모아보기</a>
				</div>
			</div>
		...
		<div id="content">
			...
			<div id="frame">
				<div id="month_clander"></div>
			</div>
		</div>
		<div id="footer">8조 - 박정현, 최기영, 하늘찬</div>
	</div>
</body>
</html>
