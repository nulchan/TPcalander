...
<%
   ...
   try{
      ...
      stmt = conn.prepareStatement("SELECT *from schedule where submit = ?");
...
<body background = "../images/background.jpg" onload="mini_calendar(null,null), big_calendar(null,null,null,null)">
    ...
    <div id="wrap">
        ...
        <div id="c_content">
		    <form action="../calander/search.jsp" method="post"><div id="content_search"><input class="search_text" id="search" name="search"type="text" value="일정검색"><input class="search_button" type="submit" value="검색"></div></form>
